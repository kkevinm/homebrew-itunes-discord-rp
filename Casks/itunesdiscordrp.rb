cask "itunesdiscordrp" do
  ...
  desc "A simple app that shows what you're currently listening to in your Discord status."
  homepage "https://github.com/kkevinm/iTunes-Discord-RP"

  app "iTunesDiscordRP.app"
end
